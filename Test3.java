...
public class Test3 extends Activity implements OnInitListener {
	...
	private void speakOut() {
		...
		tts.speak("Enter the braille code for s through the braille keyboard",TextToSpeech.QUEUE_FLUSH, null);
