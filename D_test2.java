...
public class D_test2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_d_test2);
		...
		b1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				Intent inn=new Intent(getApplicationContext(),D_test1.class);
			startActivity(inn);
			}
	 				});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.d_test2, menu);
		return true;
	}
