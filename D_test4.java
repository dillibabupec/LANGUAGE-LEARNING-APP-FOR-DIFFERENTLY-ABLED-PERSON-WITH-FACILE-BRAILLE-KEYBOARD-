...
public class D_test4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_d_test4);
		...
		b1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				Intent inn=new Intent(getApplicationContext(),D_test3.class);
			startActivity(inn);
			}
	 				});
		...
		a4.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				Intent inn=new Intent(getApplicationContext(),D_test4.class);
			startActivity(inn);
			}
	 				});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.d_test4, menu);
		return true;
	}
