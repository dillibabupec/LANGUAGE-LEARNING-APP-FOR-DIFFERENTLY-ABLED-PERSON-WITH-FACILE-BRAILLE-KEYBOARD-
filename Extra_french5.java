...
public class Extra_french5 extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_extra_french5);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQ_CODE_SPEECH_INPUT: {
            if (resultCode == RESULT_OK && null != data) {
                ...
                {
                	Intent inn=new Intent(getApplicationContext(),Extra_french4.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.extra_french5, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("  ë  one two four six",TextToSpeech.QUEUE_FLUSH, null);
