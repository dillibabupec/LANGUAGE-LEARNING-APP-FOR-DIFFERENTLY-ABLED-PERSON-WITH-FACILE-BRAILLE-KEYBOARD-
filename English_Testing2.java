...
public class English_Testing2 extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_english__testing2);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.english__testing2, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("Enter the braille code for L through the braille keyboard",TextToSpeech.QUEUE_FLUSH, null);
