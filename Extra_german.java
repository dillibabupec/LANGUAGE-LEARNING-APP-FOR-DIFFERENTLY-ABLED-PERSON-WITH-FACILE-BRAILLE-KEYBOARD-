...
public class Extra_german extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_extra_german);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.extra_german, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("Letter ä code =three four five .letter ö code =two four five. Lettr ß code =two three four six. Letter ü code =one two five six",TextToSpeech.QUEUE_FLUSH, null);
