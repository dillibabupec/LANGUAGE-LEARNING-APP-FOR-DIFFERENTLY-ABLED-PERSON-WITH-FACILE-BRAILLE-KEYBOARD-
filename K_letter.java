...
public class K_letter extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_k_letter);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQ_CODE_SPEECH_INPUT: {
            if (resultCode == RESULT_OK && null != data) {
                ...
                {
                	Intent inn=new Intent(getApplicationContext(),J_letter.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.k_letter, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("Your Letter is K and Your Braille Code is one  three",TextToSpeech.QUEUE_FLUSH, null);
