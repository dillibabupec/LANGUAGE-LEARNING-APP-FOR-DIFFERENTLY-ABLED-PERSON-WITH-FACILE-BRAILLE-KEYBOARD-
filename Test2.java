...
public class Test2 extends Activity implements OnInitListener {
	...
	private class GetDeviceList1 extends AsyncTask<String, Void, Void> {
		...
		protected void onPostExecute(Void result) {	
			...
			if(list.equals(braille))
			{
				...
				Intent inn=new Intent(getApplicationContext(),Test3.class);
				startActivity(inn);
			}
			else
			{
				...
				Intent inn=new Intent(getApplicationContext(),Test2.class);
				startActivity(inn);
			}
		}
	...
	private void speakOut() {
		...
		tts.speak("Enter the braille code for i through the braille keyboard",TextToSpeech.QUEUE_FLUSH, null);
