...
public class Eng_rev3 extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_eng_rev3);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQ_CODE_SPEECH_INPUT: {
            if (resultCode == RESULT_OK && null != data) {
                ...
                {
                	Intent inn=new Intent(getApplicationContext(),R_letter.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.eng_rev3, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("Letter M  code one three four Letter N code one three four five Letter O code one three five Letter P code one two three four Letter Q code one two three four five Letter R code one two three five ",TextToSpeech.QUEUE_FLUSH, null);
