...
public class N_letter extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_n_letter);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.n_letter, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("Your Letter is N and Your Braille Code is one    three  four five  ",TextToSpeech.QUEUE_FLUSH, null);
