...
public class Extra_french8 extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_extra_french8);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.extra_french8, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("   ë two four six",TextToSpeech.QUEUE_FLUSH, null);
