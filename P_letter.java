...
public class P_letter extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_p_letter);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQ_CODE_SPEECH_INPUT: {
            if (resultCode == RESULT_OK && null != data) {
                ...
                {
                	Intent inn=new Intent(getApplicationContext(),O_letter.class);
                	inn.putExtra("Username", username);
                	startActivity(inn);
                }
                else if(voice.equalsIgnoreCase("next"))
                {
                	Intent inn=new Intent(getApplicationContext(),Q_letter.class);
                	inn.putExtra("Username", username);
                	startActivity(inn);
                }
                else
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.p_letter, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("Your Letter is P and Your Braille Code is one  two  three   Four  ",TextToSpeech.QUEUE_FLUSH, null);
