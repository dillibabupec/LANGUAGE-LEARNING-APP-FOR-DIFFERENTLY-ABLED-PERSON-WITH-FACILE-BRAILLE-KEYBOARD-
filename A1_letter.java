...
public class A1_letter extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_a1_letter);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.a1_letter, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("The First Letter is A and the Braille Code is one .The Second Letter is à  and the braille code is one two three five six .The third letter is â une and the braille code is 16.Tap The Lower Half of Your Screen And Say Previous Or Next Whenever You want to navigate",TextToSpeech.QUEUE_FLUSH, null);
