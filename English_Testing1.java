...
public class English_Testing1 extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_english__testing1);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.english__testing1, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("Enter the braille code for a through the braille keyboard",TextToSpeech.QUEUE_FLUSH, null);
