...
public class Test1 extends Activity implements OnInitListener {
	...
	private void speakOut() {
		...
		tts.speak("Enter the braille code for b through the braille keyboard",TextToSpeech.QUEUE_FLUSH, null);
