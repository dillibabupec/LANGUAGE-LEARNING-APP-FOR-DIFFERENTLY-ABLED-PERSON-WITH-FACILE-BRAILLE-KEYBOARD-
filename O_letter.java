...
public class O_letter extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_o_letter);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.o_letter, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("Your Letter is O and Your Braille Code is one    three   five  ",TextToSpeech.QUEUE_FLUSH, null);
