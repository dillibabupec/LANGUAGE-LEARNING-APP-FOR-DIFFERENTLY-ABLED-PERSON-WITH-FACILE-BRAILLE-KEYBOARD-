...
public class G_letter extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_g_letter);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQ_CODE_SPEECH_INPUT: {
            if (resultCode == RESULT_OK && null != data) {
                ...
                {
                	Intent inn=new Intent(getApplicationContext(),H_letter.class);
                	inn.putExtra("Username", username);
                	startActivity(inn);
                }
                else
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.g_letter, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("Your Letter is G and Your Braille Code is one  two  four  five  Tap The LOwer HAlf of Your Screen and say previous or next",TextToSpeech.QUEUE_FLUSH, null);
