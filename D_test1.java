...
public class D_test1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_d_test1);
		...
		b1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				Intent inn=new Intent(getApplicationContext(),D_lesson2.class);
			startActivity(inn);
			}
	 				});
		...
		b2.setOnClickListener(new OnClickListener(){
			...
			@Override
			public void onClick(View arg0) {
				Intent inn=new Intent(getApplicationContext(),D_test2.class);
			startActivity(inn);
			}
	 				});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.d_test1, menu);
		return true;
	}
