...
public class B_letter extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_b_letter);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.b_letter, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak("Your Letter is B and Your Braille Code is one two",TextToSpeech.QUEUE_FLUSH, null);
