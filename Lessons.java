...
public class Lessons extends Activity implements OnInitListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQ_CODE_SPEECH_INPUT: {
            if (resultCode == RESULT_OK && null != data) {
                ...
                if(voice.equalsIgnoreCase("test"))
                {
                	Intent inn=new Intent(getApplicationContext(),Test1.class);
                	inn.putExtra("Username", username);
                	startActivity(inn);
                }
	...
	private void speakOut() {
		...
		tts.speak("Tap The LOwer HAlf of Your screen and say which lesson you want to Choose lesson1 or 2 or 3 or 4or test or say previous if u want to go to language selection page",TextToSpeech.QUEUE_FLUSH, null);
