...
public class Extra_french10 extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_extra_french10);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.extra_french10, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak(" ü one two five six",TextToSpeech.QUEUE_FLUSH, null);
