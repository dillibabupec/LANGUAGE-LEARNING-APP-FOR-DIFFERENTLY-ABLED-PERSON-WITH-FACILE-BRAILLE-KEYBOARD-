...
public class Extra_french extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_extra_french);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.extra_french, menu);
		return true;
	}
	...
	private void speakOut() {
		...
		tts.speak(" é   one two three four five six ",TextToSpeech.QUEUE_FLUSH, null);
